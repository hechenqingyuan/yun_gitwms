...
{
    public class MoveManagerAjaxController : AjaxPage
    {
        /// <summary>
        /// 查询分页列表
        /// </summary>
        ...
        public ActionResult GetList()
        {
            ...
            dic.Add("MoveType", MoveType.ToString());
            ...
            string result = client.Execute(MoveApiName.MoveApiName_GetDetailPage, dic);
        ...
        public ActionResult Delete()
        {
            ...
            string result = client.Execute(MoveApiName.MoveApiName_Delete, dic);
            return Content(result);
        }
        ...
        public ActionResult Cancel()
        {
            ...
            string result = client.Execute(MoveApiName.MoveApiName_Cancel, dic);
            return Content(result);
        }
        ...
        public ActionResult Audite()
        {
            ...
            string result = client.Execute(MoveApiName.MoveApiName_Audite, dic);
            return Content(result);
        }
        ...
        public ActionResult GetDetail()
        {
            ...
            string result = client.Execute(MoveApiName.MoveApiName_GetDetail, dic);
        ...
        public ActionResult ToExcel()
        {
            ...
            if (!result.IsEmpty())
            {
                DataListResult<MoveOrderDetailEntity> dataResult = JsonConvert.DeserializeObject<DataListResult<MoveOrderDetailEntity>>(result);
                List<MoveOrderDetailEntity> listResult = dataResult.Result;
                if (!listResult.IsNullOrEmpty())
                {
                    DataTable dt = new DataTable();
                    dt.Columns.Add(new DataColumn("移库单号"));
                    ...
                    dt.Columns.Add(new DataColumn("新库位"));
                    ...
                    foreach (MoveOrderDetailEntity t in listResult)
                    {
                        ...
                        row[8] = t.ToLocalName;
                        row[9] = EnumHelper.GetEnumDesc<EMoveType>(t.MoveType);
                    ...
                    string filename = string.Format("移库单{0}.xls", DateTime.Now.ToString("yyyyMMddHHmmssfff"));
                    NPOIExcel excel = new NPOIExcel("移库单", "移库单", System.IO.Path.Combine(filePath, filename));
                    excel.ToExcel(dt);
