 ...
 *
 * Author: 代码工具自动生成
 * Create Date: 2016-03-03 22:06:48
...
namespace Git.Storage.Entity.Sys
{
    public partial class AdminEntity
    {
        ...
        /// 角色名称
        /// </summary>
        [DataMapping(ColumnName = "RoleName", DbType = DbType.String)]
    ...
    [TableAttribute(DbName = "GitWMS", Name = "Admin", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class AdminEntity : BaseEntity
    {
        ...
        [DataMapping(ColumnName = "UserNum", DbType = DbType.String, Length = 50, CanNull = false, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        public string UserNum { get; set; }

        public AdminEntity IncludeUserNum(bool flag)
        {
            if (flag && !this.ColumnList.Contains("UserNum"))
            {
                this.ColumnList.Add("UserNum");
            }
            return this;
        }

        [DataMapping(ColumnName = "UserName", DbType = DbType.String, Length = 50, CanNull = false, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        [DataMapping(ColumnName = "UserCode", DbType = DbType.String, Length = 50, CanNull = false, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        [DataMapping(ColumnName = "RealName", DbType = DbType.String, Length = 100, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        [DataMapping(ColumnName = "Mobile", DbType = DbType.String, Length = 50, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        [DataMapping(ColumnName = "Picture", DbType = DbType.String, Length = 100, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        public AdminEntity IncludeParentNum(bool flag)
        {
        ...
        [DataMapping(ColumnName = "RoleNum", DbType = DbType.String, Length = 50, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        [DataMapping(ColumnName = "Remark", DbType = DbType.String, Length = 100, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        public AdminEntity IncludeCompanyID(bool flag)
        {
