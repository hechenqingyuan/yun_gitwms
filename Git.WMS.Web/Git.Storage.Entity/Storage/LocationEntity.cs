 ...
 *
 * Author: 代码工具自动生成
 * Create Date: 2016-03-03 22:18:45
...
namespace Git.Storage.Entity.Storage
{
    public partial class LocationEntity
    {
        ...
        /// 辅助查询作用-仓库库位类型
        /// </summary>
        public List<int> ListLocalType { get; set; }
    }

	[TableAttribute(DbName = "GitWMS", Name = "Location", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class LocationEntity : BaseEntity
    {
        ...
        public LocationEntity IncludeCreateUser(bool flag)
        {
        ...
        public LocationEntity IncludeCompanyID(bool flag)
        {
