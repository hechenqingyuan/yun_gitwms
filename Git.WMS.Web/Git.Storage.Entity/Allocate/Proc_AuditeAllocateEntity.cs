 ...
 *
 * Author: 情缘
 * Create Date: 2016-05-15 18:39:40
 *
 * Description: Git.Framework
 * http://www.cnblogs.com/qingyuan/
 * Revision History:
 * Date         Author               Description
 * 2016-05-15 18:39:40       情缘
*********************************************************************************/
...
{
    [TableAttribute(DbName = "GitWMS", Name = "Proc_AuditeAllocate", IsInternal = false, MapType = MapType.Proc)]
    public partial class Proc_AuditeAllocateEntity : BaseEntity
    {
        public Proc_AuditeAllocateEntity()
        {
        }
