...
{
    public class SaleReturnManagerAjaxController : AjaxPage
    {
        /// <summary>
        /// 查询销售退货单详细分页
        /// </summary>
        ...
        public ActionResult GetList()
        {
            ...
            string SaleOrderNum = WebUtil.GetFormValue<string>("SaleOrderNum", string.Empty);
            ...
            dic.Add("SaleOrderNum", SaleOrderNum);
            ...
            string result = client.Execute(SaleReturnApiName.SaleReturnApiName_GetDetailList, dic);
        ...
        public ActionResult Delete()
        {
            ...
            string result = client.Execute(SaleReturnApiName.SaleReturnApiName_Delete, dic);
            return Content(result);
        }
        ...
        public ActionResult Cancel()
        {
            ...
            string result = client.Execute(SaleReturnApiName.SaleReturnApiName_Cancel, dic);
            return Content(result);
        }
        ...
        public ActionResult Audite()
        {
            ...
            string result = client.Execute(SaleReturnApiName.SaleReturnApiName_Audite, dic);
            return Content(result);
        }
        ...
        public ActionResult GetDetail()
        {
            ...
            string result = client.Execute(SaleReturnApiName.SaleReturnApiName_GetDetail, dic);
        ...
        public ActionResult ToExcel()
        {
            ...
            if (!result.IsEmpty())
            {
                DataListResult<SaleReturnDetailEntity> dataResult = JsonConvert.DeserializeObject<DataListResult<SaleReturnDetailEntity>>(result);
                List<SaleReturnDetailEntity> listResult = dataResult.Result;
                if (!listResult.IsNullOrEmpty())
                {
                    ...
                    foreach (var t in listResult)
                    {
                        ...
                        row[6] = t.UnitName;
                        row[7] = t.Amount;
                        row[8] = t.SaleOrderNum;
                        row[9] = t.CusName;
                        row[10] = EnumHelper.GetEnumDesc<ESaleReturnStatus>(t.Status);
                    ...
                    string filename = string.Format("销售退货单{0}.xls", DateTime.Now.ToString("yyyyMMddHHmmssfff"));
                    NPOIExcel excel = new NPOIExcel("销售退货单", "销售退货单", System.IO.Path.Combine(filePath, filename));
                    excel.ToExcel(dt);
