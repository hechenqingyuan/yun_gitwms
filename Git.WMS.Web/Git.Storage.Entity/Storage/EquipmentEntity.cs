 ...
 *
 * Author: 代码工具自动生成
 * Create Date: 2016-03-03 22:18:52
...
{
	[TableAttribute(DbName = "GitWMS", Name = "Equipment", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class EquipmentEntity : BaseEntity
    {
        ...
        [DataMapping(ColumnName = "Flag", DbType = DbType.String, Length = 100, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        public EquipmentEntity IncludeCompanyID(bool flag)
        {
