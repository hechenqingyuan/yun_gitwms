...
namespace Git.Storage.Provider
{
    public static class CacheKey
    {
        ...
        //部门相关的缓存KEY值
        public static string JOOSHOW_SYSDEPART_CACHE = "JOOSHOW_SYSDEPART_CACHE_{0}";

        //角色相关的缓存KEY值
        public static string JOOSHOW_SYSROLE_CACHE = "JOOSHOW_SYSROLE_CACHE_{0}";
        ...
        //供应商资源相关的缓存KEY值
        public static string JOOSHOW_SUPPLIER_CACHE = "JOOSHOW_SUPPLIER_CACHE_{0}";

        //设备管理资源相关的缓存KEY值
        public static string JOOSHOW_EQUIPMENT_CACHE = "JOOSHOW_EQUIPMENT_CACHE_{0}";

        //仓库资源相关的缓存KEY值
        public static string JOOSHOW_STORAGE_CACHE = "JOOSHOW_STORAGE_CACHE_{0}";

        //库位资源相关的缓存KEY值
        public static string JOOSHOW_LOCATION_CACHE = "JOOSHOW_LOCATION_CACHE_{0}";

        //客户收货单位资源相关的缓存KEY值CusAddress
        public static string JOOSHOW_CUSADDRESS_CACHE = "JOOSHOW_CUSADDRESS_CACHE_{0}";

        //产品组成关系相关的缓存KEY值
        public static string JOOSHOW_PRODUCTREL_CACHE = "JOOSHOW_PRODUCTREL_CACHE";

        //产品类别管理缓存
        public static string JOOSHOW_PRODUCTCATEGORY_CACHE = "JOOSHOW_PRODUCTCATEGORY_CACHE_{0}";

        //产品缓存
        public static string JOOSHOW_PRODUCT_CACHE = "JOOSHOW_PRODUCT_CACHE_{0}";

        /// <summary>
        /// 财务类别
        /// </summary>
        public static string JOOSHOW_FINANCECATE_CACHE = "JOOSHOW_FINANCECATE_CACHE_{0}";
        ...
        /// 计量单位的统计
        /// </summary>
        public static string JOOSHOW_MEASURE_CACHE = "JOOSHOW_MEASURE_CACHE_{0}";
