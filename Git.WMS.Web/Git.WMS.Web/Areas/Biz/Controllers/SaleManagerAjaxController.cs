...
{
    public class SaleManagerAjaxController : AjaxPage
    {
        /// <summary>
        /// 查询分页列表
        /// </summary>
        ...
        public ActionResult Delete()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_Delete, dic);
            return Content(result);
        }
        ...
        public ActionResult Cancel()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_Cancel, dic);
            return Content(result);
        }
        ...
        public ActionResult GetDetail()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_GetDetail, dic);
        ...
        public ActionResult ToFiance()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_ToFiance, dic);
        ...
        public ActionResult ToStorage()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_ToOutStorage, dic);
        ...
        public ActionResult ToReturn()
        {
            ...
            string result = client.Execute(SaleApiName.SaleApiName_ToReturn, dic);
