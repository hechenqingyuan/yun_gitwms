...
namespace Git.Storage.Provider.Base
{
    ...
    {
        public PowerProvider(string CompanyID) 
        {
            ...
            using (TransactionScope ts = new TransactionScope())
            {
                ...
                if (!resItems.IsNullOrEmpty())
                {
                    ...
                    foreach (string resNum in listInfo)
                    {
                        ...
                        entity = new SysRelationEntity() { RoleNum = roleNum, ResNum = resNum, ResType = ResType,CompanyID=this.CompanyID };
        ...
        public List<SysResourceEntity> GetRoleResource(string RoleNum)
        {
            ...
            if (ListResult.IsNullOrEmpty())
            {
                ...
                ListSource = JsonHelper.DeserializeObject<List<SysResourceEntity>>(JsonHelper.SerializeObject(ListSource));
