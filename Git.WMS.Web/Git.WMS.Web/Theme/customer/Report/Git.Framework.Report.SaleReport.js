...
var SaleReport={
    Server: function () {
        var config = (function () {
            var URL_GetList = "/Report/BizAjax/SaleReportList";
            var URL_ToExcel = "/Report/BizAjax/ToSaleReportListExcel";
            return {
        ...
        //数据操作服务
        var SaleReport = (function ($, config) {
            //查询分页列表
    ...
    SetTable:function(result){
        ...
        if(pageInfo!=undefined){
            $("#mypager").pager({ pagenumber: pageInfo.PageIndex, recordCount: pageInfo.RowCount, pageSize: pageInfo.PageSize, buttonClickCallback: SaleReport.PageClick });
        }
    },
    Init:function(){
