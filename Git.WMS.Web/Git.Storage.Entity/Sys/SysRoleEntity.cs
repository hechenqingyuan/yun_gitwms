 ...
 *
 * Author: 代码工具自动生成
 * Create Date: 2016-03-03 22:06:44
...
{
	[TableAttribute(DbName = "GitWMS", Name = "SysRole", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class SysRoleEntity : BaseEntity
    {
        ...
        public SysRoleEntity IncludeSnNum(bool flag)
        {
        ...
        [DataMapping(ColumnName = "RoleName", DbType = DbType.String, Length = 100, CanNull = false, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        public SysRoleEntity IncludeCreateUser(bool flag)
        {
        ...
        public SysRoleEntity IncludeCompanyID(bool flag)
        {
