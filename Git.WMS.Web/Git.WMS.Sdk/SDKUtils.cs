 ...
 *
 * Author: 情缘
 * Create Date: 2016-03-05 11:50:32
 *
 * Description: Git.Framework
 * http://www.cnblogs.com/qingyuan/
 * Revision History:
 * Date         Author               Description
 * 2016-03-05 11:50:32       情缘
*********************************************************************************/
...
namespace Git.WMS.Sdk
{
    ...
    public sealed class SDKUtils
    {
        ...
        /// <returns></returns>
        //public string AsyncDoGet(string url, IDictionary<string, string> parameters)
        //{
        //    if (parameters != null && parameters.Count > 0)
        //    {
        //        if (url.Contains("?"))
        ...
        //    req.BeginGetRequestStream(null, this);
        //    HttpWebResponse rsp = (HttpWebResponse)req.GetResponse();
        //    Encoding encoding = Encoding.GetEncoding(rsp.CharacterSet);
        //    return GetResponseAsString(rsp, encoding);
        //}
