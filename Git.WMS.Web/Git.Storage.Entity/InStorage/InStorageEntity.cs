...
namespace Git.Storage.Entity.InStorage
{
    public partial class InStorageEntity : BaseEntity
    {
        ...
        /// <summary>
        /// 查询开始时间-CreateTime(创建时间)-辅助查询
        /// </summary>
        public string BeginTime { get; set; }

        /// <summary>
        /// 查询结束时间-CreateTime(创建时间)-辅助查询
        /// </summary>
        public string EndTime { get; set; }

    }

    [TableAttribute(DbName = "GitWMS", Name = "InStorage", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class InStorageEntity : BaseEntity
    {
        ...
        public InStorageEntity IncludeSnNum(bool flag)
        {
        ...
        public InStorageEntity IncludeSupSnNum(bool flag)
        {
        ...
        public InStorageEntity IncludeCompanyID(bool flag)
        {
