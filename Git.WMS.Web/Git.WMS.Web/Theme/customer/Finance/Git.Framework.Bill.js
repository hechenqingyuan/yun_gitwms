...
var FinanceBillManager = {
    ...
    SetTable:function(result){
        ...
        var cols=[
            ...
            {title:'付款方', name:'FromName', width: 150, align: 'center',lockWidth:false,  renderer: function(val,item,rowIndex){
                return val;
            }},
            {title:'应收金额', name:'Amount', width: 85, align: 'center',lockWidth:false,  renderer: function(val,item,rowIndex){
                return val;
            }},
            {title:'实收金额', name:'RealPayAmount', width: 100, align: 'center',lockWidth:false,  renderer: function(val,item,rowIndex){
                return val;
            }},
    ...
    ToolBar:function(){
        ...
        $("div.toolbar").find("a.btn").click(function(){
            ...
            if(command=="Add"){
                ...
                var list=FinanceBillManager.GetRows();
                if(list.length==0){
