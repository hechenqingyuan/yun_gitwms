...
namespace Git.Storage.Entity.Move
{
    ...
    [TableAttribute(DbName = "GitWMS", Name = "MoveOrder", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class MoveOrderEntity : BaseEntity
    {
        ...
        public MoveOrderEntity IncludeSnNum(bool flag)
        {
        ...
        public MoveOrderEntity IncludeAmount(bool flag)
        {
        ...
        public MoveOrderEntity IncludeCompanyID(bool flag)
        {
