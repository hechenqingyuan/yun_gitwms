 ...
 *
 * Author: 情缘
 * Create Date: 2016-04-22 16:47:39
 *
 * Description: Git.Framework
 * http://www.cnblogs.com/qingyuan/
 * Revision History:
 * Date         Author               Description
 * 2016-04-22 16:47:39       情缘
*********************************************************************************/
...
{
    [TableAttribute(DbName = "GitWMS", Name = "Reports", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class ReportsEntity : BaseEntity
    {
        ...
        public ReportsEntity IncludeSnNum(bool flag)
        {
        ...
        public ReportsEntity IncludeCompanyID(bool flag)
        {
