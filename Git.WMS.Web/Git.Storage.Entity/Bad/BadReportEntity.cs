...
namespace Git.Storage.Entity.Bad
{
    ...
    [TableAttribute(DbName = "GitWMS", Name = "BadReport", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class BadReportEntity : BaseEntity
    {
        ...
        public BadReportEntity IncludeSnNum(bool flag)
        {
        ...
        public BadReportEntity IncludeCompanyID(bool flag)
        {
