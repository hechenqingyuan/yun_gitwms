 ...
 *
 * Author: 代码工具自动生成
 * Create Date: 2016-03-03 22:19:01
...
namespace Git.Storage.Entity.Storage
{
    ...
    {
        [DataMapping(ColumnName = "SupTypeName", DbType = DbType.String)]
        public string SupTypeName { get; set; }
    }


	[TableAttribute(DbName = "GitWMS", Name = "Supplier", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class SupplierEntity : BaseEntity
    {
        ...
        public SupplierEntity IncludeSnNum(bool flag)
        {
        ...
        [DataMapping(ColumnName = "ContactName", DbType = DbType.String, Length = 100, CanNull = true, DefaultValue = null, PrimaryKey = false, AutoIncrement = false, IsMap = true)]
        ...
        public SupplierEntity IncludeCompanyID(bool flag)
        {
