...
namespace Git.Storage.Entity.Bad
{
    public partial class BadReportDetailEntity
    {
        ...
        /// 报损类型
        /// </summary>
        [DataMapping(ColumnName = "BadType", DbType = DbType.Int32)]
    ...
    [TableAttribute(DbName = "GitWMS", Name = "BadReportDetail", PrimaryKeyName = "ID", IsInternal = false)]
    public partial class BadReportDetailEntity : BaseEntity
    {
        ...
        public BadReportDetailEntity IncludeOrderSnNum(bool flag)
        {
        ...
        public BadReportDetailEntity IncludeCompanyID(bool flag)
        {
